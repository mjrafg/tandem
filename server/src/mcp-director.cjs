        ...
        sessions: {
          ...
          items: {
            ...
            properties: {
              ...
              reviewer_profile_id: { type: 'string', description: 'Optional ID of a Reviewer Agent from the AVAILABLE REVIEWER AGENTS catalog: a specialist for this session\'s independent review (e.g. video work). Omit for the standard Reviewer.' },
