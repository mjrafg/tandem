...
export const PROMPT_DEFS: PromptDef[] = [
  ...
  // ---------------------------------------------------------------- repair
  {
    ...
    default: 'The independent Reviewer evaluated the result against the user\'s request and returned these findings:\n\n{{findings}}\n\nAddress them in the project now. Fix what the findings actually say and nothing beyond it \u2014 an unrelated improvement here costs another review round. The Reviewer re-checks the repair and the checks it affects, so do not run the suite yourself.',
  },
  {
  ...
  },
  {
    ...
    roles: ['builder'],
    placeholders: ['findings'],
    default: 'The independent Reviewer evaluated your response against the user\'s request and returned these findings:\n\n{{findings}}\n\nCorrect your response now: fix what was wrong and reply with the corrected answer. Only change files if the request actually calls for it. The Reviewer re-checks this reply.',
  },
  {
  ...
  },
  {
    ...
    name: 'Final repair — findings hand-off (retired)',
    description: 'NOT USED by the engine. Superseded by reporting the open findings when the review cap is reached. Kept so historical exports stay readable.',
    group: 'repair',
    roles: ['final repair'],
    placeholders: ['findings'],
    default: 'Retired: these findings are now reported as open instead of repaired unreviewed.\n\n{{findings}}',
  ...
  // ---------------------------------------------------------------- reviewer
  {
    ...
    default: [
      ...
      'On a REPAIR review this does not start over. Your own previous round is recorded below, and findings you already confirmed and checks you already ran still stand — for the code and environment they covered. Re-run what the repair could have changed, not what it could not.',
      '',
      ...
      'Otherwise list concrete, actionable findings with file evidence, and report all of them together in this one reply.',
